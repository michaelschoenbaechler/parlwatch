...
import './app/votes/models/vote-decision.spec';
import './app/votes/store/vote/vote.vm-builder.spec';
import './app/parliament/models/parliament.model.spec';
import './app/parliament/models/open-parl-data.model.spec';
import './app/parliament/services/open-parl-data.service.spec';
import './app/parliament/store/parliament.store.spec';
import './app/parliament/guards/parliament.guards.spec';
